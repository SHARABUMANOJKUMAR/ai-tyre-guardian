...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Manoj Wheels — AI-Powered Tyre & Wheel Care" },
      { property: "og:description", content: "Drive Safer with AI-Powered Tyre Diagnostics. Upload your tyre photo & book expert services online." },
