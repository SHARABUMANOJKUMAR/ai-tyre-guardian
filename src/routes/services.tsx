...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://manojwheels.online/services" },
    ],
    links: [{ rel: "canonical", href: "https://manojwheels.online/services" }],
    scripts: [
      {
          ...
          "@graph": [
            {
              ...
              provider: { "@id": "https://manojwheels.online/#business" },
